...
const RootRedirect = () => {
  ...
  if (user.role === 'superuser') return <Navigate to="/apiculteurs" replace />;
...
export const router = createBrowserRouter([
  ...
  { element: <AuthLayout />, children: [{ path: '/login', element: <AuthPage /> }] },
    ...
    element: (
      <div className="min-h-screen flex items-center justify-center bg-[#f9f7f4]">
        <div className="text-center p-8 bg-white rounded-2xl border border-gray-100 shadow-sm max-w-sm">
          ...
          <p className="text-sm text-gray-400">Votre compte n'est pas encore associé à une coopérative.</p>
        </div>
      </div>
    ),
  },
