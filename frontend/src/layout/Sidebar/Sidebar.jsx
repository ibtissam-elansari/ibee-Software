...
/**
 * onNavigate — optional callback called after any nav-link click.
 * Used by DashboardLayout to close the mobile drawer.
 */
const Sidebar = ({ role, scopedApiculteur, onNavigate }) => {
