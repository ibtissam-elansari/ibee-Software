...
const DeleteApiculteurModal = ({ apiculteur, onConfirm, onClose, isSubmitting, error }) => {
  if (!apiculteur) return null;
  return (
    <div
    ...
    >
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div className="flex items-center gap-3 px-6 pt-6 pb-4 border-b border-gray-100">
          ...
          <h2 className="text-base font-semibold text-gray-900 flex-1">Supprimer la coopérative</h2>
        ...
        <div className="px-6 py-5 flex flex-col gap-4">
          <p className="text-sm text-gray-600">
            ...
            <span className="font-semibold text-gray-900">{apiculteur.company_name}</span> ?
            Toutes les ruches associées seront également supprimées. Cette action est irréversible.
          </p>
          {error && (
...
export default DeleteApiculteurModal;