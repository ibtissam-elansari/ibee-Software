    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-5 p-6">
        ...
        <div className="flex gap-5 items-stretch">
          ...
          {/* Left: hive info */}
          <div
            className="w-52 flex-shrink-0 bg-white rounded-2xl border border-gray-100
          ...
          >
            ...
            <div className="flex justify-end">
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                <div className="w-9 h-5 bg-gray-200 peer-checked:bg-amber-400
          ...
          <div className="flex-1 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-100">
              <h2 className="text-sm font-semibold text-gray-800">
                Paramètre de la ruche
              </h2>
              <Settings className="w-4 h-4 text-gray-300" />
            </div>

            {/* Three metric cards side by side with dividers */}
