...
# The wildcard + credentials=True combination is forbidden by the CORS spec,
# but credentials=False is correct here — your token is in the Authorization
# header (not a cookie), so credentials=False is the right setting.
app.add_middleware(
    CORSMiddleware,
    allow_origins     = ["*"],
